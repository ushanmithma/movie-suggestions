...
<head>
	...
	<title>Update <?php if (isset($name)) { echo $name . " (" . $year . ")"; } ?> - Cinema🇱🇰</title>
				...
				<div class="adding-form">
					<form method="post" id="update-form">
						<div class="form-title">
							<h1>Update <span><?php if (isset($name)) { echo $name . " (" . $year . ")"; } ?></span></h1>
						</div>
						...
						<div class="form-group">
							...
							<input list="years" name="year" id="year" value="<?php if (isset($year)) { echo $year; } ?>" autocomplete="off" maxlength="4">
							<datalist id="years">
	...
	<script>
		...
		$(document).ready(function(){
			...
			$('#update-form').on('submit', function(event) {
				...
				var currentMovieID = "<?php if(isset($id)) { echo $id; } ?>";
				var name = $("#name").val();
				var genres = [];
				...
				$.ajax({
					...
					success:function(data) {
						...
						if (data != undefined || data != null || data.length > 0) {
							...
							setTimeout(function(){
								window.location.replace("view-movie.php?id="+currentMovieID);
							}, 5000);
						}
					}
				});
